(function($) {
  'use strict';
  var tutor_window = $(window);

  // *******************************
  // :: 1.0 Preloader Active Code
  // *******************************

  tutor_window.on('load', function() {
  ...
  if($.fn.imagesLoaded) {
    $('.tutor-portfolio').imagesLoaded(function() {
      ...
      // init Isotope
      var $grid = $('.tutor-portfolio').isotope({
  ...
  if($.fn.scrollUp) {
    tutor_window.scrollUp({
      scrollSpeed: 2000,
      scrollText: '<i class="arrow_up"</i>'
    });
  }
  // :: 13.0 Sticky Active Code
  tutor_window.on('scroll', function() {
    if(tutor_window.scrollTop() > 40) {
